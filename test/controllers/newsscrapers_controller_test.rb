...
class NewsscrapersControllerTest < ActionController::TestCase
  ...
  test "should create newsscraper" do
    assert_difference('Newsscraper.count') do
      post :create, newsscraper: { body: @newsscraper.body, image_url: @newsscraper.image_url, time: @newsscraper.time, title: @newsscraper.title, title_url: @newsscraper.title_url }
    end
  ...
  test "should update newsscraper" do
    patch :update, id: @newsscraper, newsscraper: { body: @newsscraper.body, image_url: @newsscraper.image_url, time: @newsscraper.time, title: @newsscraper.title, title_url: @newsscraper.title_url }
    assert_redirected_to newsscraper_path(assigns(:newsscraper))
  end
